...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="https://raw.githubusercontent.com/anthropics/claude-code/main/assets/images/claude_icon.png" />
    <style>
      ...
      .title { font-size: 20px; font-weight: 800; color: #dc2626; }
    ...
    <div class="card">
      <div class="header">
        <svg class="logo" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M12 10h8v2h-8v-2zm0 4h8v2h-8v-2zm0 4h5v2h-5v-2z" fill="#fff"/>
        </svg>
      ...
      <div class="footer">Generated by DugóKo Blood Donation App</div>
    </div>
  </body>
</html>
`.trim();
